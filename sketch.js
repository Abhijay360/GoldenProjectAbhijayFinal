...
function setup() {
  ...
  smiley.addAnimation("smiling",smileyImg);
...
function draw() {
  ...
  textSize(30);
  fill("red");
  text("PRESS SPACE TO START",700,500)

  
  fill("green");
  text("'CLICK ON THE CUSTOMERS TO DESTROY THEM ",500,550)
  text("AND INCREASE THE INCOME'",600,600)
  }

  textSize(30);
  fill("black");
  text(" INCOME: $"+score,400,40);
...
if (gameState==="play"){
 ...
 // if (score>=10){
   ...
   if(ct===1){
    ...
    switch(ct1)
    {
      case 1: 
        ...
        customer1.setVelocity(-(5+2*score/10),(4+2*score/10));
        //ct++;
        break;

      case 2:
        customer1.visible=true;
        customer1.setVelocity(-(3+2*score/10),(2+2*score/10));
        //ct++;
        break;

        case 3: 
        customer1.visible=true;
        customer1.setVelocity(-(8+2*score/10),(2+2*score/10));
        //ct++;
        break;

       case 4:
        customer1.visible=true;
        customer1.setVelocity((5+2*score/10),(3+2*score/10));
        //ct++;
        break;

        case 5: 
        customer1.visible=true;
        customer1.setVelocity((8+2*score/10),-(1+2*score/10));
        //ct++;
        break;
  ...
  //   if(customer1.isTouching(shopkeeper)){
  //     //ct++;
  //     //customer1.setVelocity(5,-3);
  //     //customer1.addAnimation("Cwalking",c1Img2);
  //     customer1.visible=false;
  //     smiley.x=customer1.x;
  //     smiley.y=customer1.y;
  //     smiley.visible=true;
  //   }
  ...
  //   }
    ...
    switch(ct1)
    {
      case 1: 
        ...
        customer2.setVelocity(-(5+2*score/10),(4+2*score/10));
        //ct++;
        break;

      case 2:
        customer2.visible=true;
        customer2.setVelocity(-(3+2*score/10),(2+2*score/10));
        //ct++;
        break;

        case 3: 
        customer2.visible=true;
        customer2.setVelocity(-(8+2*score/10),(2+2*score/10));
        //ct++;
        break;

       case 4:
        customer2.visible=true;
        customer2.setVelocity((5+2*score/10),(3+2*score/10));
        //ct++;
        break;

        case 5: 
        customer2.visible=true;
        customer2.setVelocity((8+2*score/10),-(1+2*score/10));
        //ct++;
        break;
      default: break;
    }
  ...
  //   }
    ...
    switch(ct1)
    {
      case 1: 
        ...
        customer3.setVelocity(-(5+2*score/10),(4+2*score/10));
        //ct++;
        break;

      case 2:
        customer3.visible=true;
        customer3.setVelocity(-(3+2*score/10),(2+2*score/10));
        //ct++;
        break;

        case 3: 
        customer3.visible=true;
        customer3.setVelocity(-(8+2*score/10),(2+2*score/10));
        //ct++;
        break;

       case 4:
        customer3.visible=true;
        customer3.setVelocity((5+2*score/10),(3+2*score/10));
        //ct++;
        break;

        case 5: 
        customer3.visible=true;
        customer3.setVelocity((8+2*score/10),-(1+2*score/10));
        //ct++;
        break;
      default: break;
    }
  ...
  //   }
    ...
    switch(ct1)
    {
      case 1: 
        ...
        customer4.setVelocity(-(5+2*score/10),(4+2*score/10));
        //ct++;
        break;

      case 2:
        customer4.visible=true;
        customer4.setVelocity(-(3+2*score/10),(2+2*score/10));
        //ct++;
        break;

        case 3: 
        customer4.visible=true;
        customer4.setVelocity(-(8+2*score/10),(2+2*score/10));
        //ct++;
        break;

       case 4:
        customer4.visible=true;
        customer4.setVelocity((5+2*score/10),(3+2*score/10));
        //ct++;
        break;

        case 5: 
        customer4.visible=true;
        customer4.setVelocity((8+2*score/10),-(1+2*score/10));
        //ct++;
        break;
  ...
  //   }
    ...
    switch(ct1)
    {
      case 1: 
        ...
        customer5.setVelocity(-(5+2*score/10),(4+2*score/10));
        //ct++;
        break;

      case 2:
        customer5.visible=true;
        customer5.setVelocity(-(3+2*score/10),(2+2*score/10));
        //ct++;
        break;

        case 3: 
        customer5.visible=true;
        customer5.setVelocity(-(8+2*score/10),(2+2*score/10));
        //ct++;
        break;

       case 4:
        customer5.visible=true;
        customer5.setVelocity((5+2*score/10),(3+2*score/10));
        //ct++;
        break;

        case 5: 
        customer5.visible=true;
        customer5.setVelocity((8+2*score/10),-(1+2*score/10));
        //ct++;
        break;
  ...
  //   }
   ...
   if(customer2.isTouching(shopkeeper)){
    //ct++;
  //customer1.setVelocity(5,-3);
    //customer1.addAnimation("Cwalking",c1Img2);
    customer2.visible=false;
    smiley.x=customer2.x;
    smiley.y=customer2.y;
    smiley.visible=true;
    score+=1;
    //smiley.scale=0.5;
}

if(customer3.isTouching(shopkeeper)){
  //ct++;
//customer1.setVelocity(5,-3);
  //customer1.addAnimation("Cwalking",c1Img2);
  customer3.visible=false;
  smiley.x=customer3.x;
  smiley.y=customer3.y;
  smiley.visible=true;
  score+=1;
  //smiley.scale=0.5;
}

if(customer4.isTouching(shopkeeper)){
  //ct++;
//customer1.setVelocity(5,-3);
  //customer1.addAnimation("Cwalking",c1Img2);
  customer4.visible=false;
  smiley.x=customer4.x;
  smiley.y=customer4.y;
  smiley.visible=true;
  score+=1;
  //smiley.scale=0.5;
}

if(customer5.isTouching(shopkeeper)){
  //ct++;
//customer1.setVelocity(5,-3);
  //customer1.addAnimation("Cwalking",c1Img2);
  customer5.visible=false;
  smiley.x=customer5.x;
  smiley.y=customer5.y;
  smiley.visible=true;
  score+=1;
  //smiley.scale=0.5;
}
